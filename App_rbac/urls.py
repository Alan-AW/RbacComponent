...
urlpatterns = [
    ...
    # re_path(r'second/menu/edit/(?P<pk>\d+)/$', menu.SecondMenuEdit.as_view(), name='second_menu_edit'),
    # re_path(r'second/menu/del/(?P<pk>\d+)/$', menu.SecondMenuDel.as_view(), name='second_menu_del'),
